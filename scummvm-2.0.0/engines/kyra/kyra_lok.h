...
protected:
	...
	void startup();
	void mainLoop();
	void apConnectionScreen();   // Archipelago: in-game connect form (server/slot/password)
	void apDropReceivedItem(int engineItem);   // drop an item received from AP onto the floor
