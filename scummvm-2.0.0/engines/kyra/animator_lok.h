...
public:
	...
	// AP dev: when set, prepDrawAllObjects() skips the actor objects (indices 0-4:
	// Brandon + NPCs) but still draws ground items and scene animations. Used by the
	// "dumpscenes" debugger command to capture character-free scene screenshots.
	int _noDrawCharactersFlag;
